...
INSERT INTO products (name_en, name_fr, name_ar, description_en, description_fr, description_ar, images) VALUES
  ('Elegant Black Abaya', 'Abaya Noire Élégante', 'عباية سوداء أنيقة', 'A stunning black abaya with intricate embroidery', 'Une magnifique abaya noire avec des broderies délicates', 'عباية سوداء جميلة بتطريز معقد', '["https://images.pexels.com/photos/7679720/pexels-photo-7679720.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb),
  ('Flowing Jilbab', 'Jilbab Fluide', 'جلباب واسع', 'Comfortable and stylish jilbab for everyday wear', 'Jilbab confortable et élégant pour le quotidien', 'جلباب مريح وأنيق للاستخدام اليومي', '["https://images.pexels.com/photos/6767538/pexels-photo-6767538.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb),
  ('Silk Kimono', 'Kimono en Soie', 'كيمونو حرير', 'Luxurious silk kimono with delicate patterns', 'Kimono luxueux en soie aux motifs délicats', 'كيمونو حرير فاخر بأنماط دقيقة', '["https://images.pexels.com/photos/5370682/pexels-photo-5370682.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb),
  ('Modest Ensemble', 'Ensemble Modeste', 'طقم محتشم', 'Complete modest outfit perfect for any occasion', 'Tenue modeste complète parfaite pour toute occasion', 'طقم محتشم كامل مثالي لأي مناسبة', '["https://images.pexels.com/photos/6269449/pexels-photo-6269449.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb),
  ('Embroidered Abaya', 'Abaya Brodée', 'عباة مطرزة', 'Beautiful abaya with golden thread embroidery', 'Belle abaya avec broderie de fil doré', 'عباية جميلة بتطريز خيوط ذهبية', '["https://images.pexels.com/photos/7578390/pexels-photo-7578390.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb),
  ('Casual Jilbab', 'Jilbab Décontracté', 'جلباب كاجوال', 'Light and breathable jilbab for casual outings', 'Jilbab léger et respirant pour les sorties décontractées', 'جلباب خفيف مريح للخروجات الكاجوال', '["https://images.pexels.com/photos/6767540/pexels-photo-6767540.jpeg?auto=compress&cs=tinysrgb&w=600"]'::jsonb);
